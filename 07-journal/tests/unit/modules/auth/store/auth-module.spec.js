...
describe('Vuex: Pruebas en el auth-module', () => {
    ...
    test('Actions: createUser signinUser - Crea el usuario', async() => {
        ...
        let newUser = { name: 'Test User 2', email: 'test2@test.com', password: '123456' }
        // SignIn
        await store.dispatch('auth/signinUser', newUser )
        const { idToken } = store.state.auth

        // Borrar el usuario
        const deleteResp = await axios.post(`https://identitytoolkit.googleapis.com/v1/accounts:delete?key=AIzaSyAJVgxk3PlfG2-xEkEteTKOfYnc1ULD8Uk`, {
            idToken
        })

        newUser = { name: 'Test User 2', email: 'test2@test.com', password: '123456' }
    ...
    test('Actions: checkAuthStatus - POSITIVA', async() => {
    ...
    test('Actions: checkAuthStatus - NEGATIVA', async() => {
